...
module Problem8 =
    let Run() =
        ...
        let rec getMaxProduct startIndex currentMax =
            if value.Length <= startIndex + 5 then
                currentMax
            else
                let max x y = if x < y then y else x

                let product = 
                    int (value.[startIndex].ToString()) *
                    int (value.[startIndex + 1].ToString()) *
                    int (value.[startIndex + 2].ToString()) *
                    int (value.[startIndex + 3].ToString()) *
                    int (value.[startIndex + 4].ToString())
